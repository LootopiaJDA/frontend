...
const st = StyleSheet.create({
    ...
    locText:       { flex: 1, fontFamily: Fonts.title, fontSize: 12, color: Colors.textMuted, letterSpacing: 0.3 },
    locTextActive: { color: Colors.gold },
    locClear:      { padding: 4 },

    list:      { paddingHorizontal: Sp.lg, paddingBottom: 100 },
    empty:     { alignItems: 'center', gap: Sp.md, paddingTop: 80, paddingHorizontal: Sp.xl },
    emptyTitle:{ fontFamily: Fonts.display, fontSize: 18, color: Colors.textSecondary, textAlign: 'center', letterSpacing: 0.5 },
    emptySub:  { fontFamily: Fonts.title,   fontSize: 12, color: Colors.parchment, textAlign: 'center', lineHeight: 20 },
    clearText: { fontFamily: Fonts.title, color: Colors.gold, fontSize: 12, letterSpacing: 0.5 },
    backdrop: {
    ...
    sheetTitle: { fontFamily: Fonts.display, fontSize: 15, color: Colors.textPrimary, letterSpacing: 1, marginBottom: Sp.sm },
    option: {
        flexDirection: 'row', alignItems: 'center', gap: Sp.md,
        padding: Sp.md, borderRadius: R.md,
    },
    optionActive:     { backgroundColor: Colors.goldGlow },
    optionText:       { flex: 1, fontFamily: Fonts.title, fontSize: 13, color: Colors.textSecondary },
    optionTextActive: { color: Colors.gold },
    resetBtn:  { marginTop: Sp.sm, alignItems: 'center', padding: Sp.md },
    resetText: { fontFamily: Fonts.title, color: Colors.error, fontSize: 12, letterSpacing: 0.5 },
    ...
    cityOptionName:   { fontFamily: Fonts.title, fontSize: 13, color: Colors.textPrimary, letterSpacing: 0.2 },
    cityOptionCtx:    { fontFamily: Fonts.title, fontSize: 10, color: Colors.parchment, marginTop: 1 },
    allCitiesBtn: {
        flexDirection: 'row', alignItems: 'center', gap: Sp.sm,
        padding: Sp.md, borderRadius: R.md, backgroundColor: Colors.goldGlow,
    },
    allCitiesText: { fontFamily: Fonts.title, color: Colors.gold, fontSize: 13, letterSpacing: 0.5 },
    noCity: { fontFamily: Fonts.title, color: Colors.parchment, fontSize: 12, textAlign: 'center', padding: Sp.md },
});
