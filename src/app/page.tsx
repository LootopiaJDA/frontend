  ...
  const features = [
    {
      ...
      description:
        "Vivez une expérience immersive grâce à la technologie AR. Les indices prennent vie sous vos yeux.",
    ...
    },
    {
      ...
      description:
        "Parcourez votre ville et découvrez des lieux méconnus à travers des parcours soigneusement créés.",
    ...
    },
    {
      ...
      description:
        "Gagnez des points, débloquez des badges et grimpez au classement pour devenir le meilleur aventurier.",
    ...
    },
    {
      ...
      description:
        "Jouez seul ou en équipe, défiez vos amis et partagez vos découvertes avec la communauté.",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl text-indigo-100 leading-relaxed">
                Découvrez votre ville comme jamais avec des chasses au trésor en
                réalité augmentée. Explorez, résolvez des énigmes et gagnez des
                récompenses !
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="text-center space-y-3 p-6 rounded-xl hover:bg-gray-50 transition-colors"
              >
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 rounded-xl bg-gradient-to-r from-${stat.color}-500 to-${stat.color}-600 text-white`}
                >
                  {stat.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Une expérience unique qui combine technologie, exploration et
              gamification
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-r ${feature.color} text-white mb-4`}
                >
                  {feature.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {popularHunts.map((hunt, index) => (
              <div
                key={index}
                className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all overflow-hidden transform hover:-translate-y-2"
              >
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center space-y-8">
          ...
          <p className="text-xl text-indigo-100">
            Rejoignez des milliers de chercheurs et commencez votre première
            chasse dès maintenant
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="/partners"
              className="flex items-center gap-2 bg-white/10 backdrop-blur-sm hover:bg-white/20 px-8 py-4 rounded-xl font-bold text-lg transition-all border-2 border-white/30"
            >
